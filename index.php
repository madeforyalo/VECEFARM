...
<link rel="icon" href="imagenes/v.png" sizes="32x32" type="image/png">
<link rel="icon" href="imagenes/v.png" sizes="16x16" type="image/png">
...
<main class="form-signin w-100 m-auto">
  <form action=loggin.php>
    ...
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingInput" placeholder="Usuario" name="usu">
