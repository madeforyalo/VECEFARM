        ...
        <?php while ($fila = mysqli_fetch_assoc($res)) {
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><input type=number name=lote_id value="<?php echo ($fila['lote_id']) ?>" required style="width:70px;height:20%;"></td>
            </tr>
            <tr>
              <th>Fecha de Ingreso</th>
              <td><?php echo $fila["lote_fec_ing"] ?></td>
              <td><input type=date name=lote_fec_ing value="<?php echo ($fila['lote_fec_ing']) ?>" required></td>
            </tr>

            <tr>
              <th>Fecha de Vencimiento</th>
              <td><?php echo $fila["lote_venci"] ?></td>
              <td><input type=date name=lote_venci value="<?php echo ($fila['lote_venci']) ?>" required></td>
            </tr>

            <tr>
              <th>Lote Cantidad</th>
              <td><?php echo $fila["lote_cant"] ?></td>
              <td><input type=number name=lote_cant value="<?php echo ($fila['lote_cant']) ?>" required style="width:70px;height:50%;"></td>
            </tr>

            <tr>
              <th>Producto</th>
              <td><?php echo $fila["prod_marca"] ?>, <?php echo $fila["dro_componentes"] ?> <?php echo $fila["dro_dosis"] ?></td>
        ...
        <?php while ($fila = mysqli_fetch_assoc($res)) {
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><input type=text name=dro_componentes value="<?php echo ($fila['dro_componentes']) ?>" required style="width:100px;height:80%;"></td>
            </tr>

            <tr>
              <th>Dosificación (Mg)</th>
              <td><?php echo $fila["dro_dosis"] ?></td>
              <td><input type=number placeholder="Dosis 1.0" step="0.01" min="0" max="2000" name=dro_dosis value="<?php echo ($fila['dro_dosis']) ?>" required style="width:70px;height:50%;"></td>
            </tr>
          ...
          <?php while ($fila = mysqli_fetch_assoc($res)) { ?>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><input type=text name=prod_marca value="<?php echo ($fila['prod_marca']) ?>" required style="width:100px;height:80%;"></td>
              </tr>
              <tr>
                <th>Stock Min</th>
                <td><?php echo $fila["prod_stock_min"] ?></td>
                <td><input type=number name=prod_stock_min value="<?php echo ($fila['prod_stock_min']) ?>" required style="width:70px;height:50%;"></td>
              </tr>
              <tr>
                <th>Comprimidos</th>
                <td><?php echo $fila["prod_cant_comprimidos"] ?></td>
                <td><input type=number name=prod_cant_comprimidos value="<?php echo ($fila['prod_cant_comprimidos']) ?>" required style="width:70px;height:50%;"></td>
              </tr>
              <tr>
                <th>Precio</th>
                <td><?php echo $fila["prod_precio"] ?></td>
                <td><input type=number name=prod_precio value="<?php echo ($fila['prod_precio']) ?>" required style="width:70px;height:50%;"></td>
              </tr>
              <?php
              ...
              if (mysqli_num_rows($res) > 0) { ?>
                ...
                <?php
              } else { ?><strong style="text-align:center;color:red;">No hay Drogas cargados</strong><?php } ?>
                </tr>
...
WHERE prod_id='$dato'";
                ...
                while ($fila = mysqli_fetch_assoc($res)) {
                  ...
                  <?php
                  } else { ?><strong style="text-align:center;color:red;">No hay Laboratorios cargados</strong><?php }
                                                                                      } ?> </tr>
        ...
        ?>
          <tbody>
            ...
            <tr>
              <th>Laboratorio</th>
              <td><?php echo $fila["lab_nombre"]; ?></td>
              <td class="col-3" novalidate>
                <input type=text class="form-control" pattern="^(?=.*[A-Za-z])[A-Za-z0-9.,&-_]*$" name=lab_nombre value="<?php echo ($fila['lab_nombre']); ?>" required>
              </td>
            </tr>
          ...
          ?>
            <tbody>
              ...
              <tr>
                ...
                <td class="col-3"><input type=text class="form-control" name=emp_nom value="<?php echo ($fila['emp_nom']) ?>" required ></td>
              </tr>

              <tr>
                <th>Apellido</th>
                <td><?php echo $fila["emp_ape"] ?></td>
                <td class="col-3"><input type=text class="form-control" name=emp_ape value="<?php echo ($fila['emp_ape']) ?>" required ></td>
              </tr>

              <tr>
                <th>DNI</th>
                <td><?php echo $fila["emp_dni"] ?></td>
                <td class="col-3" class="col-3"><input type=number class="form-control" name=emp_dni value="<?php echo ($fila['emp_dni']) ?>" required ></td>
              </tr>

              <tr>
                <th>Telefono</th>
                <td><?php echo $fila["emp_tel"] ?></td>
                <td class="col-3"><input type=text class="form-control" name=emp_tel value="<?php echo ($fila['emp_tel']) ?>" required ></td>
              </tr>

              <tr>
                <th>Telefono</th>
                <td><?php echo $fila["emp_email"] ?></td>
                <td class="col-3"><input type=text class="form-control" name=emp_email value="<?php echo ($fila['emp_email']) ?>" required ></td>
              </tr>

              <tr>
                <th>Usuario</th>
                <td><?php echo $fila["emp_usu"] ?></td>
                <td class="col-3"><input type=text class="form-control" name=emp_usu value="<?php echo ($fila['emp_usu']) ?>" required ></td>
              </tr>

              <tr>
                <th>Contraseña</th>
                <td><?php echo $fila["emp_pass"] ?></td>
                <td class="col-3"><input type=text class="form-control" name=emp_pass value="<?php echo ($fila['emp_pass']) ?>" required ></td>
              </tr>
              ...
              while ($fila = mysqli_fetch_assoc($res)) {
                if (mysqli_num_rows($res) > 0) { ?>
                  <tr>
                    ...
                    <td class="col-3"><select class="form-control" name="rol">
                        <?php
                        $conn = conectar();
                        $pro = "SELECT * FROM rol";
