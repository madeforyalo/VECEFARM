...
<html>
  <body> 
    ...
    <main class="d-flex flex-nowrap">
        ...
        <li>
          ...
          <li>
            <a href="prod_list.php" class="nav-link text-white active">
 ...
 <h1 style="margin-left: 434px;">Listar Productos </h1>
          </div>
        </div>
...
$dos=$_GET['dos'];
    ...
    <form>
     <?php
    echo"<h2>Se eliminara el Producto $comp $dos Mg</h2>";
    echo"<h2> de la marca $mar</h2>";
    echo"<h2>Y todos los lotes que contengan este mismo</h2><br>";
    echo "<h2>¿Desea Confirmar la operacion?</h2><br>";
    ?>
    <input type=hidden name=marc value=<?php echo($mar)?>>
    <input type=hidden name=comp value=<?php echo($comp)?>>
    <input type=hidden name=dos value=<?php echo($dos)?>>
    <input type=hidden name=sel value=<?php echo($selec)?>>
    <input type=submit name=eli value="  SI  "  class="btn btn-secondary btn-lg" formaction=elim_prod.php>
    <input type=submit value="NO" formaction=prod_list.php class="btn btn-secondary btn-lg">
    </form><br><br><br><br>
    </div>
...
if ($ac>$min && $dif>10) {
    ...
    $color = "red";
        ...
        <tr style="color: <?php echo $color ?>">
            ...
            <td><a href=prodlist.php?modif=<?php ?>&&dato=<?php echo $fila["prod_id"]?>><i class="fa-solid fa-pen-to-square" style="color: #eff1f6;"></i></a></td>   
            
            
    <td><a href=prod_list.php?conf=<?php echo $fila["prod_id"] ?>&&marc=<?php echo $fila["prod_marca"] ?>&&comp=<?php echo $fila["dro_componentes"] ?>&&dos=<?php echo $fila["dro_dosis"] ?>><i class="fa-solid fa-trash " style="color: #f50505;" ></i></a></td>
